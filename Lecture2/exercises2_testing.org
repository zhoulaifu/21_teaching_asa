...
- Perhaps no bugs are found so far. Continue testing with sanitizers.
  ...
  + Hint: First, recompile and then "colcon test".  You could get something like  "3 packages had test failures: test_tf2 tf2_py tf2_ros". I used the command below to recompile geometry2.
